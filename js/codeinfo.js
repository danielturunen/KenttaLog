...
export const CODE_INFO = {
  ...
  "700": {
    ...
    ask: [
      ...
      "Onko defibrillaattoria (AED) käytetty ja iskettiinkö? – kertoo alkurytmistä",
      "Edeltävät oireet (rintakipu, hengenahdistus) ja perussairaudet? – johtolanka palautuviin syihin",
    ],
    assess: ["Reagoimattomuus ja normaalin hengityksen puuttuminen", "Tunnista agonaalinen (haukkova, kuorsaava) hengitys elottomuudeksi – ei saa viivyttää painelua", "Rytmi monitorista: iskettävä (VF/VT) vai ei-iskettävä (PEA/asystolia)"],
  ...
  "701": {
    ...
    ask: [
      ...
      "Perussairaudet, lääkitys ja mahdollinen hoitolinjaus (DNR)? – ohjaa elvytyspäätöstä",
    ],
    ...
    actions: ["Painelu–defibrillointi–ilmatie–syyn hoito rytmityksen mukaan", "Paina mieleen tapahtuma-ajat (rytmintarkistus, defibrillaatio, lääke, ROSC)", "ROSC: hapetus ja verenkierron tukeminen, kuljetus hoitopaikkaan"],
  ...
  "702": {
    ...
    red: ["Matala GCS + suojaamaton ilmatie", "Epätasaiset pupillit / neurologinen puutos → AVH-epäily"],
  },
  "703": {
    ...
    actions: ["Asentohoito (puoli-istuva), rauhoittaminen", "Lisähappi tavoitesaturaatioon (COPD: hallitusti, tavoite 88–92 %)", "Harkitse CPAP/NIV keuhkopöhössä hoito-ohjeen mukaan", "Syynmukainen lääkitys (esim. astma/COPD) hoito-ohjeen mukaan"],
  ...
  "704": {
    ...
    ask: [
      "Millainen kipu: puristava, painava, laaja-alainen? – tyypillinen ACS-kipu rintalastan takana",
      "Milloin alkoi ja mitä tehdessä? – alkamisaika ratkaisee hoitoikkunat; rasitusyhteys viittaa iskemiaan",
      "Säteileekö käteen, kaulaan, leukaan tai selkään? – sydänperäisen kivun tunnusmerkki",
      "Hikisyys, pahoinvointi, hengenahdistus? – liitännäisoireet nostavat riskiä",
      "Aiempi sepelvaltimotauti? Auttoiko nitro? – tunnettu tauti + tuttu kipu",
      "Riskitekijät: tupakointi, diabetes, verenpaine, kolesteroli, sukurasite? – riskiarvio",
      "Repivä, heti alussa maksimaalinen kipu selkään? – aortan dissekaation epäily",
    ],
  ...
  "711": {
    ...
    actions: ["Poista este hallitusti (yskitys, lyönnit/Heimlich tarpeen mukaan)", "Hapetus, varaudu ventilaatioon ja kajoavaan ilmatiehen"],
  ...
  "741": {
    ...
    assess: ["Vammamekanismi ja putoamiskorkeus", "cABCDE, rangan ja lantion arvio", "Tajunta ja raajojen liike/tunto"],
    actions: ["Hallitse henkeä uhkaava vuoto ensin", "Tue ranka ja immobilisoi tarpeen mukaan", "Estä jäähtyminen, kuljetus traumayksikköön"],
  ...
  "752": {
    ...
    assess: ["Peruselintoiminnot ja tajunta", "Verensokeri ja EKG tarpeen mukaan", "Pistemäiset pupillit + hengityslama → opioidi"],
    actions: ["Tukihoito (ABCDE) etusijalla", "Vasta-aineet vain hoito-ohjeen mukaan (esim. opioidi → naloksoni; huom. vaikutus loppuu ~30 min → seuranta)", "Konsultoi Myrkytystietokeskusta"],
  ...
  "754": {
    ...
    assess: ["Palovamman laajuus ja syvyys", "Hengitystiepalovamman merkit (noki, käheys, kasvojen palovamma)"],
    actions: ["Jäähdytä haalealla vedellä, suojaa, estä jäähtyminen", "Hapetus, varaudu ilmatieturvotukseen", "Kivunhoito hoito-ohjeen mukaan"],
  ...
  "761": {
    ...
    actions: ["Ilmatien turvaaminen, asentohoito", "Varaudu sokin hoitoon, nopea kuljetus runsaassa vuodossa"],
  ...
  "770": {
    ...
    assess: ["Systemaattinen ABCDE ja peruselintoiminnot", "Verensokeri, EKG tarpeen mukaan"],
    actions: ["Hoida löydösten mukaan, seuraa muutoksia", "Matala kynnys konsultaatioon"],
    red: ["Peruselintoimintojen poikkeavuus"],
  },
  "771": {
    ...
    actions: ["Matala sokeri: sokeria suun kautta jos nielee turvallisesti, muuten hoito-ohjeen mukaan i.v./i.m.", "Korkea sokeri + huono vointi: nesteytys ja kuljetus hoito-ohjeen mukaan", "Varmista syöminen ja seuranta korjauksen jälkeen"],
  ...
  "781": {
    ...
    assess: ["Kivun luonne ja sijainti", "Hemodynamiikka, vatsan tutkimus (aristus, lautamaisuus)", "Kuume"],
    actions: ["Kivunhoito hoito-ohjeen mukaan", "Tunnista kiireellistä leikkausta vaativat tilat"],
  ...
  "784": {
    ...
    assess: ["Verenkierto, tunto ja liike (iskemia?)", "Turvotus, lämpö, trauma"],
    actions: ["Tue raaja, kivunhoito", "Akuutti iskemia/laaja turvotus → kiireellinen arvio"],
    red: ["Kylmä, kalpea, pulssiton raaja → valtimotukos"],
  },
  "785": {
  ...
  "791": {
    ...
    assess: ["Synnytyksen vaihe: ehtiikö sairaalaan?", "Äidin vointi ja sikiön liikkeet"],
    actions: ["Valmistaudu synnytykseen ja vastasyntyneen hoitoon", "Vastasyntynyt: lämpö, kuivaus, hengityksen tukeminen tarvittaessa", "Äidin seuranta, varaudu vuotoon"],
  ...
  "796": {
    ...
    ask: [
      "METHANE-tiedot: mitä tapahtunut, missä, montako potilasta, mitä vaaroja, mitkä kulkureitit, mitä resursseja tarvitaan? – vakioitu tilannekuva johdolle",
