...
export const CODE_INFO = {
  ...
  "791": {
    ...
    // 1. SELVITÄ – haastattelu
    ask: [
      "Raskauden kesto (viikot)? – ennenaikaisuus nostaa riskiä; yksi vai useampi sikiö",
      "Monesko raskaus ja synnytys? Aiempien synnytysten kulku ja synnytystapa? – nopeat alatiesynnytykset ennustavat nopeaa; sektiohistoria huomioitava",
      "Mahdolliset poikkeamat raskauden kulussa ja tiedossa olevat riskit? – esim. etinen istukka, pre-eklampsia, monikkoraskaus",
      "Supistusten tiheys ja kesto? – tiheät, säännölliset supistukset = pitkällä oleva synnytys",
      "Ponnistamisen tarve? – pakonomainen ponnistustarve tarkoittaa, että synnytys on käsillä",
      "Onko lapsivesi mennyt ja minkä väristä? – vihreä vesi = mekonium, vauvan ahdinko",
      "Verenvuotoa? – runsas vuoto on hätätilanne",
    ...
    steps: [
      ...
      { t: "3. Valmistautuminen synnytyksen avustamiseen", items: [
        ...
        "Synnytysvälineistö esille",
        "Vastasyntyneelle sopiva imu, palje ja maski valmiiksi varmuuden vuoksi",
      ]},
      { t: "4. Ponnistusvaiheen hoito", ord: true, items: [
        "Hoida synnytys mieluiten sängyssä: asento puoli-istuva tai kylkiasento, lantio auki",
        "Ohjaa synnyttäjää ponnistamaan vasta, kun hänellä on siihen pakonomainen tarve",
        "Supistuksen aikana ponnistetaan 3–5 kertaa",
        "Tue toisella kädellä välilihaa ja hidasta pään syntymistä eli paina koko kämmenellä kevyesti vastaan",
        "Lapsi syntyy yleensä kasvot alaspäin, ja pään synnyttyä lapsi kääntyy kasvot sivulle päin",
        "Pään synnyttyä syntyvät hartiat. Elleivät ne synny itsestään: auta ensin ylempää hartiaa vetämällä supistuksen aikana rauhallisesti alas ja ulos, sitten alempaa hartiaa vetämällä rauhallisesti ylös ja ulos",
        "Ota lapsen kainaloista etusormilla kiinni selän puolelta – vartalo syntyy kevyesti vetämällä. Ota kunnolla kiinni, vastasyntynyt on todella liukas!",
      ]},
      { t: "5. Syntymän jälkeen: vastasyntyneen hoito", ord: true, items: [
        "Kuivaa ja stimuloi niin, että lapsi alkaa itkeä",
        "Kirjaa syntymäaika",
        "Kerro sukupuoli tai anna vanhempien tarkastaa se",
        "Anna vastasyntynyt vanhemman rinnalle ja huolehdi lämpimänä pitämisestä",
        "Varmista, että napanuoran verenvirtaus on esteetön, ja anna sen sykkiä tyhjäksi",
        "Laske Apgar-pisteet 1 ja 5 minuutin iässä",
        ...
        "Tavoitevitaalit: syke yli 100/min · hengitystaajuus yli 30/min · itkee, jäntevä, punakka iho. Elleivät täyty → stimulointi ja ventilaatiotuki hoito-ohjeen mukaan",
      ]},
      { t: "5. Syntymän jälkeen: synnyttäjän hoito", items: [
        "Vauvan synnyttyä kuljetus nopeasti sairaalaan",
        "Edistä kohdun supistumista hieromalla tai painamalla sitä kohdun päältä kohti synnytyskanavaa",
        "Tarkkaile synnyttäjän vointia ja verenvuotoa – normaali verenvuoto on noin 500 ml",
        "Avaa viimeistään nyt suoniyhteys synnyttäjälle",
        "Annostele oksitosiinia hoito-ohjeen mukaan",
        "Istukka syntyy yleensä itsestään noin 5–30 minuutin kuluttua",
        "Jos matka sairaalaan on yli 30 min, pohdi istukan ulosauttoa: ota napanuorasta kiinni ja paina kohdun pohjasta, katso seuraako istukka. Älä vedä väkisin!",
        "Pakkaa syntynyt istukka puhtaaseen muovipussiin ja toimita synnyttäjän mukana sairaalaan",
      ]},
    ],
    ...
    red: ["Poikkeava tarjonta, napanuoran esiinluiskahdus, runsas vuoto, kouristelu (eklampsia)", "Hartiat eivät synny autettunakaan (hartiadystokia) → lisäapu ja konsultaatio välittömästi"],
  },
  "792": {
